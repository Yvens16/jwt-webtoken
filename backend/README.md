...
6. Go to `localhost:5001` with your favorite browser.
...
- Home page: [GET localhost:5001/](localhost:5001/)
- Item browse: [GET localhost:5001/items](localhost:5001/items)
- Item read: [GET localhost:5001/items/:id](localhost:5001/items/2)
- Item edit: PUT localhost:5001/items/:id
- Item add: POST localhost:5001/items
- Item deletion: DELETE localhost:5001/items/:id
